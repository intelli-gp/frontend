        ...
        <div className="flex flex-column justify-between">
            ...
            <div className="flex flex-row justify-end items-center	justify-items-center w-1/5 pt-[2px]">
                <div className="   w-1/2 flex flex-row  justify-items-center ">
                    <button
                        onClick={goToBack}
                        className="w-1/4 bg-indigo-900 rounded-l-lg border-r-[1px] border-white flex p-[5px]  flex-row justify-center items-center"
                    >
                        <FaChevronLeft color="white" size="12" />
                    </button>
                    <button
                        onClick={goToToday}
                        className="w-[50%] bg-indigo-900 text-white font-light text-xs p-[5px] "
                    >
                        {' '}
                        Today
                    </button>
                    <button
                        onClick={goToNext}
                        className="w-1/4 p-[5px] bg-indigo-900 rounded-r-lg border-l-[1px] border-white flex flex-row items-center  justify-center"
                    >

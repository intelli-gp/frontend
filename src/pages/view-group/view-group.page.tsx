import { PageContainer, EditButton, GroupCoverImage, GroupCoverImageContainer, PictureOverlay, GroupInfoContainer, LeftPart, PeopleContainer, RightPart } from "./view-group.styles";
                ...
                <LeftPart>
                    ...
                    <div className="w-full">
                        <div className="flex justify-between items-center">
                            ...
                            >
                                {isEditingDescription ? <FiSave size={21} />
                                    : <FiEdit size={18} />}
                            </EditButton>
                        </div>
                        <div className="flex gap-2 items-center justify-left mt-4 text-txt w-full">
                            {isEditingDescription ? <InputWithoutLabel
                            value={description}
                ...
                <RightPart>
                    ...
                    <PeopleContainer>
                        {data.admins.map((admin) => (
                            <div className=" flex flex-col gap-[8px] justify-center items-center"><img src={defaultUserImage} /><h1>{admin}</h1></div>
                        ))}
                    </PeopleContainer>
                    <br />
                    <br />
                    ...
                    <PeopleContainer>
                        {data.members.map((member) => (
                            <div className=" flex flex-col gap-[8px] justify-center items-center"><img src={defaultUserImage} /><h1>{member}</h1></div>
                        ))}
                    </PeopleContainer>
                </RightPart>
            </GroupInfoContainer>
